    ...
    <div class="container col-6 mt-5">
        <form ref="form" @submit.prevent="submit">
            ...
            <div class="form-group mb-3">
                ...
                <input class="form-control" @input="restrictYearInput" type="number" id="year" v-model="form.year"
                    required min="1800" max="2023">
            </div>
            ...
            <button @click="submit" class="btn btn-primary">Add Movie</button>
        </form>
